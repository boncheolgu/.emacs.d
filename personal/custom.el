(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company-lsp lsp-rust lsp-mode cargo rust-mode yasnippet writegood-mode window-numbering web-mode vlf switch-window solarized-theme markdown-mode iedit hungry-delete helm-ls-hg helm-ls-git helm-flycheck google-c-style flycheck-pyflakes flycheck-irony company-irony-c-headers company-irony company cmake-mode cmake-ide clang-format auto-complete auctex geiser anaconda-mode mediawiki key-chord json-mode js2-mode haskell-mode rainbow-mode elisp-slime-nav rainbow-delimiters helm-projectile helm smex ido-completing-read+ flx-ido zop-to-char zenburn-theme which-key volatile-highlights undo-tree smartrep smartparens smart-mode-line operate-on-number move-text magit projectile ov imenu-anywhere guru-mode grizzl god-mode gitignore-mode gitconfig-mode git-timemachine gist flycheck expand-region epl editorconfig easy-kill diminish diff-hl discover-my-major dash crux browse-kill-ring beacon anzu ace-window)))
 '(show-paren-mode t)
...
(custom-set-faces
 ...
 '(magit-diff-added ((t (:background "dark slate gray"))))
